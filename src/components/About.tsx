...
import seaf from "../../public/images/sseaf.jpg";
import arab from "../../public/images/arab2.jpeg";
import aou from "../../public/images/aouu.jpg";
import arab1 from "../../public/images/arab1.jpeg";

import { motion } from "framer-motion";

export default function About() {
  const images = [seaf, arab1, aou, arab];
  return (
    <div>
      ...
      <div className="max-w-4xl">
        <Paragraph className=" mt-4">
          Hey there, I&apos;m Seaf Gamel – a Full-Stack Developer, Coach, and
          Instructor. I&apos;m a Computer Science student from Egypt, currently
          living in Saudi Arabia. I’m also proud to have won third place in the
          Olympics of AI across Egypt.
        </Paragraph>
        <Paragraph className=" mt-4">
